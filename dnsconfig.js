...
D(
  ...
  CNAME("bayonne", "equalstreetnames.github.io.", CF_PROXY_ON),
  ...
  CNAME("bucharest", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("budapest", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("copenhagen", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("chorzow", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("crest", "equalstreetnames.github.io.", CF_PROXY_ON),
  ...
  CNAME("fuerth", "equalstreetnames.github.io.", CF_PROXY_ON),
  ...
  CNAME("lisbon", "equalstreetnames.github.io.", CF_PROXY_ON),
  ...
  CNAME("malaga", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("munich", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("narva", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("nantes", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("oldenburg", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("paris", "equalstreetnames.github.io.", CF_PROXY_ON),
  CNAME("pau", "equalstreetnames.github.io.", CF_PROXY_ON),
